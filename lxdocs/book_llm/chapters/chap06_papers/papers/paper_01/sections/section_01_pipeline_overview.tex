\section{Pipeline stages which convert input to final output.}
  \begin{enumerate}
    ...
    \begin{enumerate}
        \item Stage-14: Prompt construction for LLM to generate scores and instructions
        \item Stage-15: LLM generates scores and instructions (critique)
        \item Stage-16: Prompt construction for LLM to refine the MCQs
        \item Stage-17: LLM generates refined MCQs (revised stem, key unchanged)
    \end{enumerate}

    
    \item \textbf{Quality Assurance and Output}
    \begin{enumerate}
        \item Stage-18: MCQ Validation and Evaluation
        
        \item Stage-19: Final Output Formatting
    \end{enumerate}
  \end{enumerate}