...
\chapter{MCQGen: A Large Language Model-Driven MCQ Generator for Personalized Learning} 
  ...
  \clearpage
  \input{\subfix{sections/section_16.tex}}

  \clearpage
  \input{\subfix{sections/section_16_01.tex}}

  \clearpage
  \input{\subfix{sections/section_17.tex}}
  ...
  \clearpage
  \input{\subfix{sections/section_04.tex}}
  \input{\subfix{sections/section_05.tex}}
  
  \clearpage
  \input{\subfix{sections/section_06.tex}}
  
  \clearpage
  \input{\subfix{sections/section_07.tex}}
  
  \clearpage
  \input{\subfix{sections/section_08.tex}}
  
  \clearpage
  \input{\subfix{sections/section_09.tex}}

  \clearpage
  \input{\subfix{sections/section_10.tex}}
  \input{\subfix{sections/section_11.tex}}

  \clearpage
  \input{\subfix{sections/section_12.tex}}
  \input{\subfix{sections/section_13.tex}}

  \clearpage
  \input{\subfix{sections/section_14.tex}}

  \clearpage
  \input{\subfix{sections/section_15.tex}}
    ...
    \end{enumerate} 
      ...
      \section{Ideas}
        \begin{enumerate}
          ...
          \item MCQ generation based on gaps identified using an essay written by student
